...
requestCurrent.onload = function(){
    ...
    document.getElementById('w_icon').src = franklinWeather.current_observation.icon_url.replace("http", "https");
...
forecast.open("GET", "https://api.wunderground.com/api/6710307f40d51364/forecast10dat/q/MN/Franklin.json", true );
conditionsText.send();

conditionsText.onload = function (){
    var text = JSON.parse(forecast.responseText);
    console.log(text);
    document.getElementById('day1').innerHTML = text.forecast.txt_forecast.forecastday["0"].fcttext;
    document.getElementById('imgday1').src = franklinWeather.current_observation.icon_url.replace("http", "https");
    document.getElementById('high1').innerHTML = text.forecast.txt_forecast.forecastday["0"].fcttext;
    document.getElementById('low1').innerHTML = text.forecast.txt_forecast.forecastday["0"].fcttext;
}
